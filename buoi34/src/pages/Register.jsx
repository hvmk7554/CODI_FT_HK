...
import { register,getListUser } from "../rtk/slices/authSlice";
    ...
    <Pagelayout>
      <div className="flex flex-wrap min-h-screen w-full content-center justify-center bg-gray-200 py-10">
        <div className="w-full xl:w-3/4 lg:w-11/12 flex">
          <div className="w-full h-auto bg-gray-400 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg bg-[url('https://cookingorgeous.com/wp-content/uploads/2021/06/lamb-shish-kebab-19.jpg')]" />
