    ...
    <Pagelayout>
      <div className="flex flex-wrap content-center justify-center w-full min-h-screen py-10 bg-gray-200">
        <div className="flex shadow-md">
          <div
            className="flex flex-wrap content-center justify-center bg-white rounded-l-md"
          ...
          >
            <div className="w-72">
              ...
              <div className="flex flex-wrap content-center mb-3 item-center">
                <Check />
                <label
                  htmlFor="remember"
          ...
          >
            <img
              ...
              src="https://www.yummymummykitchen.com/wp-content/uploads/2021/10/nigiri-sashimi-sushi.jpg"
            />
          </div>
        </div>
      </div>
