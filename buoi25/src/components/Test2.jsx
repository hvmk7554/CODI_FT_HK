    ...
    <div className="flex justify-center">
        <div>
            <div className="flex">
                ...
                <button onClick={handleAdd} className="w-10 h-10 text-white bg-blue-500 rounded-xl mx-5 mt-8">
                    Add
                </button>
            ...
            <div>
                {todolist.length > 0 && todolist.map((item, index) => (
                    ...
                    >
                        <p> {item} </p>
                        <Check />
                        <button onClick={() => handleDelete(index)} className="w-10 h-10 text-white bg-red-500 rounded-xl mx-5 mt-8">
                            Delete
                        </button>
                    </div >
                ))}
